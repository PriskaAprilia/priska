    ...
    <div class="navbar-nav">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
        ...
        <div class="container-fluid">
            ...
            <input type="hidden" name="tanggal" value="<?php echo ['tp']; ?>">
            <input type="hidden" name="jumlah" value="<?php echo ['j']; ?>">
              <?php } ?>
    <?php
        if (isset($_GET['simpan'])) {
           $jlm = $_GET['j'];
            ...
            for ($a=0; $a < $jlm ; $a++) { ?>
                ...
                <div class="form-group">
                    ...
                    <select name="jb[]" id="">
                        ...
                        <option value="oriplame">oriplame</option>
                        <option value="maybellin">maybellin</option>
