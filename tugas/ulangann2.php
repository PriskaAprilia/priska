        ...
        <div class="col-md-12">
            <div class="card badge-danger">
                ...
                <div class="form-group">
                    ...
                    <select name="jb[]" id="">
                        <option value="buku">NOVEL BOY CANDRA</option>
                        <option value="karton">NOVEL TELELY</option>
                        <option value="kertas">NOVEL SENJA</option>
                        <option value="lem">NOVEL RISA</option>
                        <option value="pensil">NOVEL KUMPLIT</option>
                    </select>
                </div>
                <div class="form-group">
